...
- added separator-grid detection (`grid_detect.py`) and `grid_fill_between` strategy: fills empty grid cells between same-color blocks along rows/cols; `06df4c85` now solves via derive
